...
if (isset($_POST['submit'])) {
  ...
  //Masukkan soalan ke dalam database
  ...
  if ($insert_row) {
    foreach ($pilihan as $pilihan_jawapan => $pilih) {
      ...
      //Semak jika pilihan tidak kosong
      if ($pilih != '') {

        //Setkan jawapan yang betul
        ...
        //Masukkan pilihan ke dalam database
    ...
    <table width="100%" border="0" align="center">
      <tr>
        <td align="center">
          ...
          <!-- Form di mana semua info soalan baru mesti diisi -->
