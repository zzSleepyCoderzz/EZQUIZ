...
<body>
  ...
  <center>
    ...
    <div>
      <a href="subjek_daftar.php">
        <button id="button1">Daftar Subjek </button>
      </a>
    </div>
    </p>
  </center>
  ...
  <main>
    <table width="60%" border="0" align="center" style="font-size:16px;font-family:DIN Next LT Pro Light;">
      ...
      //Dapatkan dan paparkan semua subjek
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="hapus_subjek.php?idsubjek=<?php echo $info1['idsubjek']; ?>" onclick="return confirm ('Awas!!!, Topik, Soalan dan jawapan akan dihapuskan. Anda Pasti?')">
