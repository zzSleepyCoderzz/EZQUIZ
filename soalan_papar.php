...
//Dapatkan semua soalan yang berkaitan dengan topik
...
//Dapatkan soalan berdasarkan nombor
...
//Dapatkan pilihan berdasarkan nombor
    ...
    <table width="70%" border="0" align="center">
      <tr>
        <td align="center">
          ...
          <!-- Audio yang dimainkan sekiranya betul atau salah-->
      ...
      <tr>
        <td align="center">
          <hr>
          <p style='font-weight:1000;margin:0;'>Soalan <?php echo $number; ?> dari <?php echo $total; ?></p>
          <br>
          <br>
          ...
          //Papar gambarajah yang disimpan
