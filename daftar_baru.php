...
if (isset($_POST['idpengguna'])){
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     <center style="margin-left:20px;margin-top:30px;"> <p id = "p1">PENDAFTARAN PENGGUNA BARU</p></center>
     <center>
       <br>
       <br>
         ...
         <tr>
           <td align = "center">
             <form method="POST">
               ...
               <div id = "div2">
                 <p><input id = "inputkp" onblur = "checkLength(this)" type="text" name="idpengguna" placeholder="Tanpa tanda -" maxlength = "12" size = "30"
               ...
               <div id = "div2">
                 <p><input id = "inputpin" type="password" name="password" placeholder="4 digit sahaja" maxlength = "4" size="30"
                 onkeypress="return event.charCode >= 48 && event.charCode <= 57" required></p>
               </div>
               <br>
               <br>
               ...
               <br>
               <div id = "div1">
                 <button id = "new1" type="submit">DAFTAR</button>
